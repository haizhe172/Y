				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="150px" class="tdColor tdC">景点</td>
							<td width="200px" class="tdColor tdC">景点介绍</td>
							<td width="150px" class="tdColor tdC">是否营业</td>
						...
						<tr>
							...
							<td><?php echo $v['scene_text']?></td>
							<td><?php echo $v['scenee_start']==1?"营业":"停业"?></td>
							<td><?php echo date("Y-m-d h:i:s",$v['create_time'])?></td>
							<td>
								<a href="javascript:void(0)"><img id="update" scene_id="<?php echo $v['scene_id']?>" class="operation" src="<?php echo IMG_URL;?>update.png"></a> 



								<img id="delete" scene_id="<?php echo $v['scene_id']?>" class="operation delban" src="<?php echo IMG_URL;?>delete.png">
							</td>
						</tr>
					<?php }?>
					</table>
...
<script>
	$(function(){
		$(document).on("click","#update",function(){
			...
			location.href = "/?r=admin/scene/update&scene_id="+scene_id;
		});

		$(document).on("click","#delete",function(){
			var scene_id = $(this).attr("scene_id");
			$.ajax({
				url: '/?r=admin/scene/delete',
				type: 'get',
				dataType: 'json',
				data: {id:scene_id},
